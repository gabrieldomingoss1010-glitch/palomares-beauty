...
import { LayoutDashboard, Upload, Library, FileText, Video } from 'lucide-react';
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-[220px] fixed inset-y-0 left-0 flex flex-col bg-gradient-to-b from-wine-dark via-wine to-[#6b4a4a] text-rose-light z-20">
